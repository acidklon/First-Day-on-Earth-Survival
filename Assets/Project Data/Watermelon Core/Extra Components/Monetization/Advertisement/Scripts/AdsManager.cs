...
namespace Watermelon
{
    ...
    public static class AdsManager
    {
        ...
        public static void Initialise(MonetizationSettings monetizationSettings)
        {
            ...
            save = SaverManagerMy.GetSaveObject<AdSave>("advertisement_forced_ad");
            ...
            /*if (!SavesYG.HasKey(FIRST_LAUNCH_PREFS))
            {
                lastInterstitialTime = Time.time + settings.InterstitialFirstStartDelay;

                SavesYG.SetInt(FIRST_LAUNCH_PREFS, 1);
            }
            else
            {
        ...
        {
            SavesYG.SetInt(GDPR_PREF_NAME, state ? 1 : 0);
        ...
        {
            return SavesYG.GetInt(GDPR_PREF_NAME, 0) == 1 ? true : false;
        }

        public static bool IsGDPRStateExist()
        {
            return SavesYG.HasKey(GDPR_PREF_NAME);
        }
        #endregion
