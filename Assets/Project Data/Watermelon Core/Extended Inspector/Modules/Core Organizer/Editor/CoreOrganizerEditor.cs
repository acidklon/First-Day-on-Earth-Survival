...
namespace Watermelon
{
    ...
    public class CoreOrganizerEditor : Editor
    {
        ...
        protected void PrepareStyles()
        {
            ...
            labelStyle = new GUIStyle(EditorCustomStyles.Skin.label);
            ...
            iconAdd = new GUIContent(EditorCustomStyles.GetIcon("icon_add"));
            iconRemove = new GUIContent(EditorCustomStyles.GetIcon("icon_close"));
            iconUp = new GUIContent(EditorCustomStyles.GetIcon("icon_triangle_up"));
            iconDown = new GUIContent(EditorCustomStyles.GetIcon("icon_triangle_down"));
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(UPDATE_STATUS_LABEL, EditorCustomStyles.buttonBlue))
            {
                for (int i = 0; i < coreSettingsProperty.arraySize; i++)
                {
                    OpenElement(i);
            ...
            if (GUILayout.Button(ORGANIZE_LABEL, EditorCustomStyles.buttonGreen))
            {
                for (int i = 0; i < coreSettingsProperty.arraySize; i++)
                {
                    OpenElement(i);
