...
namespace Watermelon
{
    public class EnergyController : MonoBehaviour
    {
        ...
        {
            instance = this;
            save = SaverManagerMy.GetSaveObject<EnergySave>("Energy");
            ...
            if (difference > 0)
            {
                ...
                if (foodConsumedText == null)
                {
                    ...
                    if (LocalizationManager.CurrentLanguage == "English")
                        ...
                        foodConsumedText = FloatingTextController.SpawnFloatingText(FLOATING_TEXT_HASH, $"+{newPoints} ›Õ≈–√»ﬂ <sprite name={currency.CurrencyType}>", PlayerBehavior.InstanceTransform.position.AddToY(2f), Quaternion.identity, Color.white).GetComponent<FloatingTextBehaviour>();
                ...
                else
                {
                    ...
                    if (LocalizationManager.CurrentLanguage == "English")
                        ...
                        foodConsumedText.SetText($"+{lastDisplayedFoodPoints} ›Õ≈–√»ﬂ <sprite name={currency.CurrencyType}>");
